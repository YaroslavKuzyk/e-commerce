...
class AdminProductController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'clearance_price' => 'nullable|numeric|min:0|required_if:is_clearance,true',
            'clearance_reason' => 'nullable|string|max:500|required_if:is_clearance,true',
    ...
    public function addVariant(Request $request, int $id): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'clearance_reason' => 'nullable|string|max:255',
